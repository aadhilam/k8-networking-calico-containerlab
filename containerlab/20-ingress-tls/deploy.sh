#!/bin/bash
# filepath: /Users/aadhilamajeed/k824/container-labs/containerlab/20-ingress-tls/deploy.sh
...
echo ""
echo "NEXT STEPS: Follow the README to manually install and configure:"
echo ""
echo "  Phase 1 - Install cert-manager:"
echo "    kubectl apply -f https://github.com/cert-manager/cert-manager/releases/download/v1.16.2/cert-manager.yaml"
echo ""
echo "  Phase 2 - Deploy Demo Applications"
echo "  Phase 3 - Create Certificate Issuers"
echo "  Phase 4 - Issue Certificates"
echo "  Phase 5 - Configure TLS Gateway & Routes"
echo "  Phase 6 - Test the Setup"
echo ""
echo "The manifests are located in:"
echo "  - tls-config/     (ClusterIssuers, Certificates)"
echo "  - k8s-manifests/  (Apps, Gateway, Routes)"
echo ""
