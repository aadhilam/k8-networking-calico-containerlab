...
1. **Delete the Kind cluster** (headless-services) and all associated containers
...
```bash
sudo containerlab destroy -t headless-services.clab.yaml
```
...
docker ps | grep headless-services
