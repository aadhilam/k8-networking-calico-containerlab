#!/bin/bash
# filepath: /Users/aadhilamajeed/k824/container-labs/containerlab/21-macvlan/deploy.sh
...
echo "  - VLAN 20: Macvlan network (10.10.20.0/24)"
echo ""
echo "=== Next Steps ==="
echo "Before deploying pods with macvlan, you need to:"
...
echo "4. Apply the macvlan NetworkAttachmentDefinition (see README.md step 6)"
echo "5. Then deploy a test pod (see README.md step 7)"
echo ""
